...
import 'animate.css';
import projImg1 from "../assets/img/my_proj_1.png";
import projImg2 from "../assets/img/my_proj_2.png";
import projImg3 from "../assets/img/my_proj_3.png";
import projImg4 from "../assets/img/my_proj_4.png";
import projImg5 from "../assets/img/my_proj_5.png";
import projImg6 from "../assets/img/my_proj_6.png";
              ...
              <div className= "animate__animated animate__fadeIn" >
                ...
                <Tab.Container id="projects-tabs"  defaultActiveKey="first" >
                  ...
                  <Tab.Content id="slideInUp" expand="sm" className= "animate__animated animate__slideInUp__faster" >
                    ...
                    <p className="txt animate__animated animate__backInUp animate__delay-1s mt-5 text-center text-light " >My name is Shimaa , I live in Cairo , this is the first project in react Dev.</p>                    </Tab.Pane>
                  </Tab.Content>
                </Tab.Container>
              </div>
